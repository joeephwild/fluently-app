...
const Dashboard = () => {
    ...
    return (
        <>
            ...
            <Box>
                <Text color='#F0C400' fontWeight={500}>Hey Johnson</Text>
                <Text my='.5em' fontWeight={700}>Your language partner is waiting for you.</Text>
                        ...
                        <Table>
                            ...
                            <Tbody fontSize='.9em'>
                                <Tr>
                                    ...
                                    <Td>
                                        <Flex gap={4}>
                                            <Button fontSize='.9em' bg='#FDD835'>Join Session</Button>
                                            <Button 
                                                fontSize='.9em' 
                                                color='#FDD835' 
